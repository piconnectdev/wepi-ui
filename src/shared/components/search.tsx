...
export class Search extends Component<any, SearchState> {
  ...
  static fetchInitialData(req: InitialFetchRequest): Promise<any>[] {
    ...
    let community_id = communityId == null ? undefined : communityId;
    if (community_id) {
  ...
  search() {
    let community_id =
      this.state.communityId == null ? undefined : this.state.communityId;
    let creator_id =
      this.state.creatorId == null ? undefined : this.state.creatorId;
