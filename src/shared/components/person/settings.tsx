...
import { createPayment, utf8ToHex } from "../../pisdk";
/*
eth001,
gasPrice,  
utf8ToHex,
...
export class Settings extends Component<any, SettingsState> {
  ...
  depositHtmlForm() {
    return (
      <>
        <h5>{I18NextService.i18n.t("Send to")}</h5>
        <form>
            ...
            <div className="form-group">
              ...
              >
                {this.state.depositLoading ? (
                  ...
                  capitalizeFirstLetter(I18NextService.i18n.t("Send"))
                )}
              </button>
            </div>
          )}
  ...
  sendPaymentHtmlForm() {
    return (
      <>
        <h5>{I18NextService.i18n.t("Send Payment")}</h5>
        <form onSubmit={linkEvent(this, this.handleChangePasswordSubmit)}>
          <div className="form-group row">
            ...
            >
              {I18NextService.i18n.t("PaymentId")}
            </label>
            <div className="col-sm-7">
              <input
                type="text"
              ...
              >
                {this.state.depositLoading ? (
                  ...
                  capitalizeFirstLetter(
                    I18NextService.i18n.t("Pay (Admin only)")
                  )
                )}
              </button>
            </div>
  ...
  balanceHtmlForm() {
    return (
      <>
        <h5>{I18NextService.i18n.t("Balance statistics")}</h5>
        <form>
          <div className="form-group row">
            <label className="col-sm-5 col-form-label" htmlFor="user-spent">
              {I18NextService.i18n.t("Spent")}
            </label>
            <div className="col-sm-7">
              <input
                readOnly={true}
          ...
          <div className="form-group row">
            <label className="col-sm-5 col-form-label" htmlFor="user-received">
              {I18NextService.i18n.t("Received")}
            </label>
            <div className="col-sm-7">
              <input
                readOnly={true}
          ...
          <div className="form-group row">
            ...
            >
              {I18NextService.i18n.t("Withdrawed")}
            </label>
            <div className="col-sm-7">
              <input
                type="text"
            ...
            <div className="form-group">
              ...
              >
                {this.state.withdrawLoading ? (
                  ...
                  capitalizeFirstLetter(I18NextService.i18n.t("Balance"))
                )}
              </button>
            </div>
          }
          <div className="form-group row">
            <label className="col-sm-5 col-form-label" htmlFor="user-withdraw">
              {I18NextService.i18n.t("Withdraw Amount")}
            </label>
            <div className="col-sm-7">
              <input
                type="text"
            ...
            <div className="form-group">
              ...
              >
                {this.state.withdrawLoading ? (
                  ...
                  capitalizeFirstLetter(I18NextService.i18n.t("Withdraw"))
                )}
              </button>
            </div>
          }
  ...
  communityBlock(res: RequestState<BlockCommunityResponse>) {
    if (res.state === "success") {
      ...
      const data = wsJsonToRes<GetPiBalancesResponse>(msg);
      this.setState({
        balanceState: {
          spent: data.spent,
      ...
      const data = wsJsonToRes<PiWithdrawResponse>(msg);
      toast(i18n.t("Withdrawal success") + data.id);
      const getUser = UserService.Instance.myUserInfo;
      const auth = myAuth(true);
      if (getUser && auth) {
        const formCheckBalance: GetPiBalances = {
      ...
      const data = wsJsonToRes<PiPaymentCompleteResponse>(msg);
  ...
  async handlePiLoginSubmit(i: Settings, event: any) {
    ...
    const form = new PiLogin();

    const username_or_email = ea.account;
    const password = i.state.changePasswordForm.new_password;
