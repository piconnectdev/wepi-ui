...
export const supportUrl = `https://demo.wepi.social/`;
...
export function isAdmin(creatorId: string, admins?: PersonViewSafe[]): boolean {
...
export function getIdFromProps(props: any): string | undefined {
  let id: string = props.match.params.post_id;
  return id ? id : undefined;
}

export function getCommentIdFromProps(props: any): string | undefined {
...
export function getCommentParentId(comment?: CommentI): string | undefined {
...
export function insertCommentIntoTree(
  ...
  if (parentId) {
    ...
    _uuid = insertString(_uuid, 18, "-");
    _uuid = insertString(_uuid, 23, "-");
    let parent_comment = searchCommentTree(tree, _uuid);
    if (parent_comment) {
